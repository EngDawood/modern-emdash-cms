/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 63cea70368ab5ff2a3249e880b0d5b78)
// Runtime types generated with workerd@1.20260603.1 2026-03-29 nodejs_compat
interface __BaseEnv_Env {
	...
	EMDASH_URL: string;
	EMDASH_TOKEN: string;
	EMDASH_OAUTH_GITHUB_CLIENT_ID: string;
	EMDASH_OAUTH_GITHUB_CLIENT_SECRET: string;
	DASHBOARD_API_KEY: string;
	RESEND_API_KEY: string;
	JOBS_API_URL: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/worker").EmDashMCP>;
	SELF: Service<typeof import("./src/worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "EmDashMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMDASH_URL" | "EMDASH_TOKEN" | "EMDASH_OAUTH_GITHUB_CLIENT_ID" | "EMDASH_OAUTH_GITHUB_CLIENT_SECRET" | "DASHBOARD_API_KEY" | "RESEND_API_KEY" | "JOBS_API_URL">> {}
}
